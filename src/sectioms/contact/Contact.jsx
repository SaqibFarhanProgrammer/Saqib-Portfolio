...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center  text-white px-4 z-10 relative">
      <div className="w-full max-w-3xl rounded-xl shadow-2xl backdrop-blur-2xl bg-gradient-to-b from-[#f5f5f5]/80 to-[#4338ca]/60 p-10 z-10 relative">
        ...
        >
          ...
          <div className="flex flex-col z-10 relative">
            ...
            />
            {errors.email && (
              <span className="text-xs text-red-600 mt-1">Email is required</span>
            )}
          </div>
